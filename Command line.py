...
# `python _options_ -c command (-m module | file) args
...
# HOT TIP: Use `i**` when you want to get an interactive session immediately after running some script, with top-level variables still intact and available for inspection
